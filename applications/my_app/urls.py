...
urlpatterns = [
    ...
    ## CHANGE PERMISSION
    path('user/<int:user_id>/folder/<int:folder_id>/change-permission/', views.api_change_folder_permission, name='change_folder_permission'),
    ## DELETE
    ...
    # upload
    path('user/<int:user_id>/sync/save-drive-token/', views.api_save_drive_token, name='save_drive_token'),
